// 全局变量
let selectedAPIs = JSON.parse(localStorage.getItem('selectedAPIs') || '["tyyszy","dyttzy","bfzy","ruyi","yutu"]'); // 默认选中天涯资源、暴风资源和如意资源
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (!localStorage.getItem('hasInitializedDefaults')) {
        // 仅选择天涯资源、暴风资源和如意资源
        selectedAPIs = ["tyyszy","bfzy","dyttzy","ruyi","yutu"];
